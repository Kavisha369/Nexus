...
2. **Setup**: Place these files in your `htdocs` folder.
3. **Database Config**: Update the `user` and `pass` in `db.php` to match your local database settings.
4. **Go!**: Open `http://localhost/nexus` in your browser.

<img width="1522" height="822" alt="image" src="https://github.com/user-attachments/assets/dea07090-24ab-4c76-8aa8-7fbc6ab56590" />


<img width="1520" height="815" alt="image" src="https://github.com/user-attachments/assets/1d63a373-6907-4166-90ce-7cec7cca12ef" />


<img width="1532" height="808" alt="image" src="https://github.com/user-attachments/assets/d91a13c7-f44d-4f31-9a0a-2eb73fdf25f9" />
